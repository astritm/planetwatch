...
def write(state):
 ...
 with st.expander("I. Type 1 sensor - outdoor"):
  st.markdown( """
              <html style="color: blue; text-align:left;">Q1. How can I buy a Type one sensor (Airqino)</html>
             ...
             ---
              ...
              <html style="color: blue; text-align:left;">Q1. How much does Type 1 sensor costs?</html>
             ...
             ---
              ...
              <html style="color: blue; text-align:left;">Q3. How do I know if ther are Type 1 sensors in my area?</html>
             ...
             ---
              <html style="color: blue; text-align:left;">Q4. How can I activate my Airqino when it's delivered?</html>
 ...
 with st.expander("II. Type 2 sensor - outdoor"):
  st.markdown( """
              <html style="color: blue; text-align:left;">Q1. How can I buy a Type 2 sensor?</html>
                  A1. First you have to buy a Type 1 license at planetwatch <html><a href="https://www.planetwatch.io/pick-your-license/">website</a> </html>.
                  They will put you in the queue basted on the licenses sold and number of sensors available for the next batches.
                  For EU users payment is done only in PLANETS for the sensor and for the license.
                  You will be notified from the planetwatch team when you are available to purchanse the sensor.
             ...
             ---
              ...
              <html style="color: blue; text-align:left;">Q2. Is there a Type 2 sensor currently available in the market?</html>
              A2. NO!
                  Not at the time of writing this Q&A.
             
             ---
             
              <html style="color: blue; text-align:left;">Q3. How do I know if ther are Type 2 sensors in my area?</html>
              A3. Go to the planetwatch <html><a href="https://map.planetwatch.io/map/">map</a></html>
                  At search place box type your address.
                  You will see the area with rectangles (they are 0.72km2).
                  If one of the rectangles has a color, click there and scroll down on the page on the left.
 ...
 with st.expander("III. Type 3 sensor - indoor (Premium)"):
   st.markdown( """
              <html style="color: blue; text-align:left;">Q1. How can I buy a Type3 sensor?</html>
             ...
             ---
              ...
              <html style="color: blue; text-align:left;">Q3. Can I have Type3 and Type4 at my home (same location)?</html>
              A1. Yes!
 ...
 with st.expander("IV. Type 4 sensor - indoor"):
   st.markdown( """
              <html style="color: blue; text-align:left;">Q1. Can I have more than one T4 sensor at my home?</html>
             ...
             ---
              ...
              <html style="color: blue; text-align:left;">Q2. Should I buy the license first to get in queue for the sensor?</html>
              A2. You can buy the Type4 sensor without buying the license firts.
                  As the time of writing this answer, there are two qualified products as Planetwatch T4 sensors Awair Elements and Atmotube Pro!
             
             ---
             
              <html style="color: blue; text-align:left;">Q3. Can I have more than one T4 sensor at my home?</html>
              A3. No, only one Type per household is allowed. 
                  The execpeption being with Atmotube Pro which has to be away from the same location for 30 percent of the time
             
             ---                                  
             
             <html style="color: blue; text-align:left;">Q4. Is the new Type 4 device going to be able to connect directly to PlanetWatch servers or does it need to connect to a PlanetWatch App from a smartphone?</html>
 ...
 with st.expander("V. Licenses related"):
   st.markdown( """
              <html style="color: blue; text-align:left;">Q1. Can I use 1 license for two sensors?</html>
              A1. NO! 
                  One license per sensor.
                  
             ---
             
              <html style="color: blue; text-align:left;">Q2. Do I need to have different emails address for buying more than one license?</html>
              A2. NO!
                  You can buy as much licenses as you want with your single email address.
                  
             ---
             
              <html style="color: blue; text-align:left;">Q3. Is there a coupon code for licenses?</html>
 ...
 with st.expander("V. PLANETS Token"):
   st.markdown( """
              <html style="color: blue; text-align:left;">Q1. On which exchange can I buy PLANETS?</html>
             ...
             ---
              ...
              <html style="color: blue; text-align:left;">Q2. What wallet should I use for PLANETS token?</html>
 ...
 with st.expander("VI. Other related questions"):
    st.markdown( """
              <html style="color: blue; text-align:left;">Q1. Are there videos, instructions about planetwatch project?</html>
