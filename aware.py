...
def write(state):
 ...
 st.info('Enable API first as expalined in the awair official web [here] (https://support.getawair.com/hc/en-us/articles/360049221014-Awair-Element-Local-API-Feature#h_01F40FBBW5323GBPV7D6XMG4J8). DMZ is also required to be able to access the Awair IP from the outside world!')
